...
davis_val_mapper= {'bike-packing': 0, 'blackswan': 1, 'bmx-trees': 2, 'breakdance': 3, 'camel': 4, 'car-roundabout': 5, 
'car-shadow': 6, 'cows': 7, 'dance-twirl': 8, 'dog': 9, 'dogs-jump': 10, 'drift-chicane': 11, 
'drift-straight': 12, 'goat': 13, 'gold-fish': 14, 'horsejump-high': 15, 'india': 16, 'judo': 17, 'kite-surf': 18, 
'lab-coat': 19, 'libby': 20, 'loading': 21, 'mbike-trick': 22, 'motocross-jump': 23, 'paragliding-launch': 24, 
'parkour': 25, 'pigs': 26, 'scooter-black': 27, 'shooting': 28, 'soapbox': 29}
    ...
    def __call__(self, dataset_dict):
        ...
        for frame_idx in selected_idx:
            ...
            for _anno in sorted_annos:
                if _anno["id"] != -1:
                    _gt_ids.append(ids[_anno["id"]])
                else:
                    _gt_ids.append(-1)
                #_gt_ids = [ids[_anno["id"]] for _anno in sorted_annos]
            #except:
            #    print(sorted_annos, ids, _gt_ids, len(sorted_annos))
